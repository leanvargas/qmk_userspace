...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case ACCENT:
        if (record->event.pressed) {
            SEND_STRING(SS_DOWN(X_ALGR) SS_TAP(X_QUOT) SS_UP(X_ALGR));
        } else {
            // when keycode ACCENT is released
        }
        break;
    }
    return true;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x5_2(
        KC_TRNS,    KC_1,        KC_2,        KC_3,        ACCENT,            KC_HOME,        KC_PGDN,        KC_PGUP,       KC_BSPC,   KC_END,
        KC_TRNS,    KC_4,        KC_5,        KC_6,        HACEK,             KC_LEFT,        KC_DOWN,        KC_UP,         KC_RGHT,   KC_TRNS,
		CW_TOGG,    KC_7,        KC_8,        KC_9,        KC_0,              KC_TRNS,        KC_DEL,         KC_TRNS,       KC_TRNS,   KC_TRNS,
    ...
    [2] = LAYOUT_split_3x5_2(
		...
		KC_BSLS,    EURO,        KC_CIRC,     KC_DLR,      KC_HASH,           KC_PLUS,        KC_UNDS,        KC_EQL,        KC_TRNS,   KC_NO,
    ...
    [3] = LAYOUT_split_3x5_2(
		...
		KC_TRNS,    KC_TRNS,     KC_BRID,     KC_BRIU,     KC_TRNS,           KC_F12,         KC_F7,          KC_F8,         KC_F9,     KC_TRNS,
